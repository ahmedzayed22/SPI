 ...
 *
 * SPI_CLK_PHA_SETUP_FIRST
 * SPI_CLK_PHA_SAMPLE_FIRST
 *
 * */

#define SPI_CLK_PHASE_SELECT	SPI_CLK_PHA_SETUP_FIRST
...
#define SPI_CLK_PRESCALER_SELECT	SPI_CLK_PRESCALER_16
